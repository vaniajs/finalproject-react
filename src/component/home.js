                    ...
                    {/* <div className="carousel slide justify-content-end" data-ride="carousel" id="carouselExampleSlidesOnly" > */}
                        <div className="row">
                            <div className="col-md-8">
                                <img className="w-40" src={carousel} alt="GIF" style={{marginLeft:'-30px', zIndex:'-1'}} />
                            ...
                            <Link to='/featured-products'><p className='shopnow'>SHOP NOW >></p></Link>
                            </div>
