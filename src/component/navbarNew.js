          ...
          {this.props.username !== '' ?
            <Nav className="ml-auto" navbar>
              ...
              {this.props.role === 'admin' ?
                ...
                : <NavItem className='bt-link'>
                  <Link to='/cart-detail' className='bt-link' onMouseOver={() => this.setState({ modal: true })} onMouseLeave={() => this.setState({ modal: false })}><NavLink className='bt-link' style={styling} className='bt-link'><i className="fas fa-shopping-cart s-cart" /><Label circular color='#E16868' className='inline'>{this.props.cart}</Label>  </NavLink></Link>
